...
<header>
   <div class="mm">
                ...
                <div class="loginbutton">
                 ...
                 <%} else { %>
                   <a class="logintext" href="${cp }/user/logout.us">로그아웃</a>
                    <a class="jointext" href="${cp}/app/user/pwidentify.jsp">내정보</a>
                  <%} %>
    ...
    <main>
        <div class ="main">
        <div class="slide_name">인기 낚시터</div>
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><img src="${cp}/img/main_fzone_1.jpg" alt=""></div>
                  <div class="swiper-slide"><img src="${cp}/img/main_fzone_2.jpg" alt=""></div>
                  <div class="swiper-slide"><img src="${cp}/img/main_fzone_3.jpg" alt=""></div>
                </div>
            ...
            <div class="mallarea">
                <div class="mall">
                    <div class="mallzone1">
                        <img src="${cp}/img/logo3.png">
                    </div>
                    <div class="mallzone2">
                        <img src="${cp}/img/logo4.jpg">
                    </div>
                </div>
                <div class="mall2">
                    <div class="mallzone3">
                        <img src="${cp}/img/logo6.jpg">
                    </div>
                    <div class="mallzone4">
                        <img src="${cp}/img/logo7.png">
                    </div>
                </div>
                <div class="mall3">
                    <div class="mallzone5">
                        <img src="${cp}/img/logo8.jpg">
                    </div>
                </div>
            </div>
        </div>
