...
<title>Insert title here</title>
 ...
 <link href="${pageContext.request.contextPath}/css/idfind2.css" rel="stylesheet">
 ...
 <header>
   <div class="mm">
    ...
    <main>
        ...
        <div class="explain_area1">
            고객님의 계정을 찾았습니다
        </div>
        <div class="explain_area2">
            아이디 확인 후 로그인 해주세요
        </div>
        <div class="account_view_area">
            ...
            <div class="regdate_area">
                가입일 : 1995.02.11
            </div>
        </div>
        <div class="button_area">
            <input type="button" id="find_pw" name="find_pw" onclick="" value="비밀번호 찾기">
            <div id="usedblank"></div>
            <input type="button" id="ok_button" name="ok_button" onclick="" value="확인">
        </div>
    </main>
    <footer>
        <div>
