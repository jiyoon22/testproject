...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/idfind.css">
...
%>
   ...
   <div class="mm">
                ...
                <li class="morelist" id="over">
                    ...
                    <div class="sublist" name="sublist">
                        ...
                        <div id=more_sub class="morelist_sub2">
                          <a href="${cp }/QnA/QnAView.jsp">자주 묻는 질문</a>
                        </div>
    ...
    <div class="container">
    <form name="findidForm" method="post" action="${cp}/user/idfind.us" onsubmit="return sendit()" style="margin-top:50px">
          <table class="idtable">
            <tr>
                <td>
        </td>
            ...
            <tr>
                <td id="name1" colspan="3"><label for="userid">이름</label></td>
            </tr>
            <tr>
              <td colspan="2"><input type="text" name="nametext1" placeholder="이름을 입력해주세요" class="box22" id="username" onkeyup="checkname(this.value)">
            </tr>
            <tr>
                <td id="nameresult" colspan="3"></td>
            </tr>
...
function sendit() {
    ...
    const phonenumber = findidForm.phonenumber;
    const verification = findidForm.verification;
