...
<div class="join">
        ...
        <form name="joinForm" method="post" action="${cp}/user/userjoinok.us" onsubmit="return sendit();" >
            <table>
                ...
                <tr>
                    <td colspan="2"><input type="text" name="userid" id="userid" onkeyup="checkid(this.value)"></td>
                ...
                <tr>
                    <td colspan="3"><input type="text" name="username" id="username"  onkeyup="checkname(this.value)" ></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><input type="text" name="verification" id="verification" placeholder="인증번호" onkeyup="checkveri(this.value)">
                    <span id="timer" class="timer">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3:00</span></td>
...
<script>
 function sendit() {
    ...
    if(userid.value.length<5 || userid.value.length>12){
        document.getElementById('idresult').innerHTML="아이디는 5자이상 12자 이하로 입력해주세요";
        document.getElementById('idresult').style.color="red";
        userid.focus();
        return false;
    }
...
function checkid(value) {
   ...
   if(value.search(/\s/) != -1){
      ...
      idresult.innerHTML="아이디는 5자이상 12자 이하로 입력해주세요"
      idresult.style.color="red";
      return false;
   }
   else if(value=="") {
...
function checkaddr(value){
	if(value==""){
		...
		adresult.innerHTML="올바른 주속를 입력해주세요";
		adresult.style.color="red";
		return false;
	}
	else {
...
function sendcode() {
 ...
 $('.btn_checked1').attr("disabled", true); //비활성화
