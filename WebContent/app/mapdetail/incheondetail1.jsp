...
<div class="container">
            ...
            <div id="thbox1"><img src="${cp }/img/황청낚시터.jpg" alt="돈까스"></div>
            <div id="debox1">황청낚시터</div>
            ...
            <div id="thbox2">
            <p>주소 : 인천 강화군 내가면 황청리 531</p>
            <p>전화번호 : 010-3459-2266</p>
            <p>매일 08:00 - 22:00
             - 문의전화 08:00 ~ 21:00</p>
            
            <p>가격표<br>
            민물낚시대 대여가능(낚시장비,밑밥) 변동<br>
            잔교낚씨요금/남성 30,000원<br>
            잔교 낚시요금/여성,고등학생 이하 20,000원</p>
            </div>
            </div>
            </div>
