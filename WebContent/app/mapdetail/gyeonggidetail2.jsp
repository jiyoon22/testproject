...
<div class="container">
            ...
            <div id="thbox1"><img src="${cp }/img/서신바다낚시터.jpg" alt="돈까스"></div>
            <div id="debox1">서신바다낚시터</div>
            ...
            <div id="thbox2">
            <p>주소 : 경기 화성시 서신면 송교리 42-5</p>
            <p>전화번호 : 031-357-9366</p>
            <p>24시간 영업 연중무휴</p>
            
            <p>가격표<br>
            남자(12시간) 88,000원<br>
            여자/어린이(12시간) 66,000원<br>
            5시간 55,000원<br>
            방갈로 짬낚시 20,000원<br>
            방갈로 풀낚시 30,000원</p>
