...
<div class="container">
            ...
            <div id="thbox1"><img src="${cp }/img/해신바다낚시터.jpg" alt="돈까스"></div>
            <div id="debox1">해신바다낚시터</div>
            ...
            <div id="thbox2">
            <p>주소: 서울특별시 강북구 도봉로 204</p>
            <p>전화번호 : 0507-1405-8925</p>
            <p>토요일, 일요일 및 공휴일 10:00 - 01:00 평일 12:00 - 24:00</p>
            <p>가격표<br>
            1시간 26,000원
            2시간 39,000원<br>
            3시간 50,000원
            4시간 55,000원</p>
            <p>
            *1시간추가 16,000원 *초등학생 이하 5,000원 할인<br>
            *새우미끼 무료 *3시간, 4시간 이용시 지렁이 1통무료<br>
            *시간내 2마리 못 잡을시 자동 30분 연장서비스(1시간 =1마리)<br>
            방류 및 이벤트 내용은 전날 공지합니다.(카페 공지 참조)<br>
            -이벤트는 2시간이상 이용가능합니다-<br>
            <a href="http://cafe.naver.com/haesinfish" target='_blank'>http://cafe.naver.com/haesinfish</a><br>
            </p>
            </div>
            </div>
            </div>
