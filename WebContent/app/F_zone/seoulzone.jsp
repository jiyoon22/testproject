   ...
   <div class="mm">
    ...
    <main>
        <div class="main">
            ...
            <div class="areabox">
                <button class="area" onclick="location.href='${cp}/app/F_zone/seoulzone.jsp'" style="background-color: #233156; color:white;">서울특별시</button>
            ...
            <div class="cafebox1">
                <a class="picturebox" href="${cp }/app/mapdetail/seouldetail1.jsp">
                    <img src="${cp }/img/해신바다낚시터.jpg">
                </a>
                <div class="namebox">
                    <a href="${cp }/app/mapdetail/seouldetail1.jsp">해신바다낚시터</a>
                </div>
                <div class="mapbox">
            ...
            <div class="cafebox1">
                <a class="picturebox" href="${cp }/app/mapdetail/seouldetail2.jsp" >
                    <img src="${cp }/img/후킹실내바다낚시터.jpg">
                </a>
                <div class="namebox">
                    <a href="${cp }/app/mapdetail/seouldetail2.jsp" >후킹실내바다낚시터</a>
                </div>
                <div class="mapbox">
            ...
            <div class="cafebox1">
                <a class="picturebox" href="${cp }/app/mapdetail/seouldetail3.jsp">
                    <img src="${cp }/img/히어로낚시카페.jpg">
                </a>
                <div class="namebox">
                    <a href="${cp }/app/mapdetail/seouldetail1.jsp">히어로낚시카페</a>
                </div>
                <div class="mapbox">
            ...
            <div class="cafebox2">
                <a class="picturebox" href="map1.html" onclick="window.open(this.href, '_black'); return false;">
                    <img src="${cp }/img/착한붕어낚시카페.jpg">
                </a>
                <div class="namebox">
                    <a href="map1.html" onclick="window.open(this.href, '_black'); return false;">착한붕어 낚시카페</a>
                </div>
                <div class="mapbox">
            ...
            <div class="cafebox2">
                <a class="picturebox" href="map1.html" onclick="window.open(this.href, '_black'); return false;">
                    <img src="${cp }/img/빅히트바다낚시터.jpg">
                </a>
                <div class="namebox">
                    <a href="map1.html" onclick="window.open(this.href, '_black'); return false;">빅히트 바다낚시터</a>
                </div>
                <div class="mapbox">
                    <a class="nmap" href="map1.html" onclick="window.open(this.href, '_black'); return false;">카카오맵 검색</a>
                </div>
            ...
            <div class="cafebox2">
                <a class="picturebox" href="map1.html" onclick="window.open(this.href, '_black'); return false;">
                    <img src="${cp }/img/잉어킹낚시카페.jpg">
                </a>
                <div class="namebox">
                    <a href="map1.html" onclick="window.open(this.href, '_black'); return false;">잉어킹 낚시카페</a>
                </div>
                <div class="mapbox">
                    <a class="nmap" href="map1.html" onclick="window.open(this.href, '_black'); return false;">카카오맵 검색</a>
                </div>
