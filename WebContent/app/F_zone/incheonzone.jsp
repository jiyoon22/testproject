 ...
 <main>
        <div class="main">
            ...
            <div class="areabox">
                ...
                <button class="area" onclick="location.href='${cp}/app/F_zone/gyeonggizone.jsp'">경기도</button>
                <button class="area" onclick="location.href='${cp}/app/F_zone/incheonzone.jsp'"style="background-color: #233156; color:white;" >인천광역시</button>
            ...
            <div class="cafebox1">
                <a class="picturebox" href="${cp }/app/mapdetail/incheondetail1.jsp">
                    <img src="${cp }/img/황청낚시터.jpg">
                </a>
                <div class="namebox">
                    <a href="${cp }/app/mapdetail/incheondetail1.jsp">황청낚시터</a>
                </div>
                <div class="mapbox">
                    <a class="nmap" onclick="popup()">카카오맵 검색</a>
                </div>
            </div>
            <div class="cafebox1">
                <a class="picturebox" href="${cp }/app/mapdetail/incheondetail2.jsp" >
                    <img src="${cp }/img/만정바다좌대낚시터.jpeg">
                </a>
                <div class="namebox">
                    <a href="${cp }/app/mapdetail/incheondetail2.jsp">만정바다좌대낚시터</a>
                </div>
                <div class="mapbox">
            ...
            <div class="cafebox1">
                <a class="picturebox" href="${cp }/app/mapdetail/incheondetail3.jsp">
                    <img src="${cp }/img/선재레저바다낚시터.jpg">
                </a>
                <div class="namebox">
                    <a href="${cp }/app/mapdetail/incheondetail3.jsp">선재레저바다낚시터</a>
                </div>
                <div class="mapbox">
            ...
            <div class="cafebox2">
                <a class="picturebox" href="map1.html" onclick="window.open(this.href, '_black'); return false;">
                    <img src="${cp }/img/어부바낚시카페.jpg">
                </a>
                <div class="namebox">
                    <a href="map1.html" onclick="window.open(this.href, '_black'); return false;">어부바 낚시카페</a>
                </div>
                <div class="mapbox">
            ...
            <div class="cafebox2">
                <a class="picturebox" href="map1.html" onclick="window.open(this.href, '_black'); return false;">
                    <img src="${cp }/img/대동실내낚시터.jpg">
                </a>
                <div class="namebox">
                    <a href="map1.html" onclick="window.open(this.href, '_black'); return false;">대동실내낚시터</a>
                </div>
                <div class="mapbox">
                    <a class="nmap" href="map1.html" onclick="window.open(this.href, '_black'); return false;">카카오맵 검색</a>
                </div>
            ...
            <div class="cafebox2">
                <a class="picturebox" href="map1.html" onclick="window.open(this.href, '_black'); return false;">
                    <img src="${cp }/img/꿀잼실내낚시카페.png">
                </a>
                <div class="namebox">
                    <a href="map1.html" onclick="window.open(this.href, '_black'); return false;">꿀잼실내낚시카페</a>
                </div>
                <div class="mapbox">
                    <a class="nmap" href="map1.html" onclick="window.open(this.href, '_black'); return false;">카카오맵 검색</a>
                </div>
