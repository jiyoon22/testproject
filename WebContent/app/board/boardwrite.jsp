   ...
   <div class="mm">
	...
	<div id="wrap">
				...
				<tr>
					...
					<td class="file1_cont">
						...
						<div style="float:right; margin-right:100px;">
							<a id="b_modify" href="javascript:upload('file1')">파일 선택</a>
							<a id="b_delete" href="javascript:cancelFile('file1')">첨부 삭제</a>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="file2_cont">
						...
						<div style="float:right; margin-right:100px;">
							<a id="b_modify2" href="javascript:upload('file2')">파일 선택</a>
							<a id="b_delete2" href="javascript:cancelFile('file2')">첨부 삭제</a>
						</div>
					</td>
				</tr>
			</table>
		...
		<table class="btn_area">
			<tr align="right" valign="middle">
				<td>
					<a id="b_Registration" href="javascript:sendit()">등록</a>&nbsp;&nbsp;
					<a id="b_list" href="${cp}/board/boardlist.bo?page=${param.page}&keyword=${param.keyword}">목록</a>
				</td>
			</tr>
		</table>
	</div>
